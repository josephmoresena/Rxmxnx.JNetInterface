...
#pragma warning restore CA1859
	...
	{
		public new TResult? Invoke(JLocalObject jLocal) => base.Invoke(jLocal, ReadOnlySpan<IObject?>.Empty);
		public new TResult? Invoke(JLocalObject jLocal, JClassObject jClass)
		...
		public new TResult? StaticInvoke(JClassObject jClass)
			=> base.StaticInvoke(jClass, ReadOnlySpan<IObject?>.Empty);
