...
public partial class Launcher
{
	private partial class Linux
	{
		...
		private static readonly Dictionary<JdkVersion, String> armhfUrl = new()
		{
			{
				JdkVersion.Jdk8,
				"https://cdn.azul.com/zulu-embedded/bin/zulu8.90.0.19-ca-jdk8.0.472-linux_aarch32hf.tar.gz"
			},
			{
				JdkVersion.Jdk11,
				"https://cdn.azul.com/zulu-embedded/bin/zulu11.84.17-ca-jdk11.0.29-linux_aarch32hf.tar.gz"
			},
			{
				JdkVersion.Jdk17,
				"https://cdn.azul.com/zulu-embedded/bin/zulu17.60.17-ca-jdk17.0.16-c2-linux_aarch32hf.tar.gz"
			},
		};
