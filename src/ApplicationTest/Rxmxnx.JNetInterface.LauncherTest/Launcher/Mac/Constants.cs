...
public partial class Launcher
{
	private partial class Mac
	{
		private static readonly Dictionary<JdkVersion, String> amd64Url = new()
		{
			...
			{ JdkVersion.Jdk8, "https://cdn.azul.com/zulu/bin/zulu8.90.0.19-ca-jdk8.0.472-macosx_x64.tar.gz" },
		...
		{
			{ JdkVersion.Jdk8, "https://cdn.azul.com/zulu/bin/zulu8.90.0.19-ca-jdk8.0.472-macosx_aarch64.tar.gz" },
