...
internal partial interface IPrimitiveNumericType<TPrimitive, TValue>
{
	...
	public static readonly TPrimitive AdditiveIdentity =
		NativeUtilities.Transform<TValue, TPrimitive>(TValue.AdditiveIdentity);
	/// <inheritdoc cref="IMultiplicativeIdentity{TSelf, TResult}.MultiplicativeIdentity"/>
	public static readonly TPrimitive MultiplicativeIdentity =
		NativeUtilities.Transform<TValue, TPrimitive>(TValue.MultiplicativeIdentity);
	...
	public static TPrimitive UnaryPlus(in TValue value) => NativeUtilities.Transform<TValue, TPrimitive>(+value);

	/// <inheritdoc cref="IUnaryNegationOperators{TSelf, TResult}.op_UnaryNegation(TSelf)"/>
	public static TPrimitive UnaryNegation(in TValue value) => NativeUtilities.Transform<TValue, TPrimitive>(-value);
