...
internal sealed partial class EnvironmentCache
{
		...
		JFieldId fieldId)
	{
		...
		switch (signature)
		{
			...
			case CommonNames.ByteSignatureChar:
				this.SetPrimitiveStaticField(classRef, bytes, signature, fieldId, in staticFieldFunctions.SetByteField);
				break;
			case CommonNames.CharSignatureChar:
				this.SetPrimitiveStaticField(classRef, bytes, signature, fieldId, in staticFieldFunctions.SetCharField);
				break;
			...
			case CommonNames.IntSignatureChar:
				this.SetPrimitiveStaticField(classRef, bytes, signature, fieldId, in staticFieldFunctions.SetIntField);
				break;
			case CommonNames.LongSignatureChar:
				this.SetPrimitiveStaticField(classRef, bytes, signature, fieldId, in staticFieldFunctions.SetLongField);
				break;
	...
	private void SetPrimitiveStaticField<TPrimitive>(JClassLocalRef classRef, ReadOnlySpan<Byte> bytes, Byte signature,
		JFieldId fieldId, ref readonly SetGenericFieldFunction<JClassLocalRef, TPrimitive> setValue)
	...
	/// <param name="signature">Primitive char signature.</param>
	/// <param name="fieldId"><see cref="JFieldId"/> identifier.</param>
	private void SetPrimitiveField(JObjectLocalRef localRef, ReadOnlySpan<Byte> bytes, Byte signature, JFieldId fieldId)
	{
		...
		{
			case CommonNames.BooleanSignatureChar:
				this.SetPrimitiveField(localRef, bytes, signature, fieldId, in instanceFieldFunctions.SetBooleanField);
				break;
			case CommonNames.ByteSignatureChar:
			...
			case CommonNames.CharSignatureChar:
				...
				break;
			case CommonNames.DoubleSignatureChar:
				this.SetPrimitiveField(localRef, bytes, signature, fieldId, in instanceFieldFunctions.SetDoubleField);
				break;
			case CommonNames.FloatSignatureChar:
				this.SetPrimitiveField(localRef, bytes, signature, fieldId, in instanceFieldFunctions.SetFloatField);
				break;
			case CommonNames.IntSignatureChar:
			...
			case CommonNames.LongSignatureChar:
				...
				break;
			case CommonNames.ShortSignatureChar:
				this.SetPrimitiveField(localRef, bytes, signature, fieldId, in instanceFieldFunctions.SetShortField);
				break;
		}
		this.CheckJniError();
	}
	...
	/// <param name="signature">Primitive char signature.</param>
	/// <param name="fieldId"><see cref="JFieldId"/> identifier.</param>
	private void GetPrimitiveStaticField(Span<Byte> bytes, JClassLocalRef classRef, Byte signature, JFieldId fieldId)
	{
		ref readonly FieldFunctionSet<JClassLocalRef> staticFieldFunctions =
		...
		switch (signature)
		{
			case CommonNames.BooleanSignatureChar:
				...
				break;
			case CommonNames.ByteSignatureChar:
				this.GetPrimitiveStaticField(bytes, classRef, signature, fieldId, in staticFieldFunctions.GetByteField);
				break;
			case CommonNames.CharSignatureChar:
				this.GetPrimitiveStaticField(bytes, classRef, signature, fieldId, in staticFieldFunctions.GetCharField);
				break;
			case CommonNames.DoubleSignatureChar:
				this.GetPrimitiveStaticField(bytes, classRef, signature, fieldId,
			...
			case CommonNames.FloatSignatureChar:
				...
				break;
			case CommonNames.IntSignatureChar:
				this.GetPrimitiveStaticField(bytes, classRef, signature, fieldId, in staticFieldFunctions.GetIntField);
				break;
			case CommonNames.LongSignatureChar:
				this.GetPrimitiveStaticField(bytes, classRef, signature, fieldId, in staticFieldFunctions.GetLongField);
				break;
			case CommonNames.ShortSignatureChar:
				this.GetPrimitiveStaticField(bytes, classRef, signature, fieldId,
	...
	private void GetPrimitiveField(Span<Byte> bytes, JObjectLocalRef localRef, Byte signature, JFieldId fieldId)
	{
		...
		{
			case CommonNames.BooleanSignatureChar:
				this.GetPrimitiveField(bytes, localRef, signature, fieldId, in instanceFieldFunctions.GetBooleanField);
				break;
			case CommonNames.ByteSignatureChar:
			...
			case CommonNames.CharSignatureChar:
				...
				break;
			case CommonNames.DoubleSignatureChar:
				this.GetPrimitiveField(bytes, localRef, signature, fieldId, in instanceFieldFunctions.GetDoubleField);
				break;
			case CommonNames.FloatSignatureChar:
				this.GetPrimitiveField(bytes, localRef, signature, fieldId, in instanceFieldFunctions.GetFloatField);
				break;
			case CommonNames.IntSignatureChar:
			...
			case CommonNames.LongSignatureChar:
				...
				break;
			case CommonNames.ShortSignatureChar:
				this.GetPrimitiveField(bytes, localRef, signature, fieldId, in instanceFieldFunctions.GetShortField);
				break;
		}
		this.CheckJniError();
	}
	...
	[SuppressMessage(CommonConstants.CSharpSquid, CommonConstants.CheckIdS107,
	                 Justification = CommonConstants.PrimitiveCallJustification)]
#endif
	private unsafe void CallPrimitiveFunction<TPrimitive>(Span<Byte> bytes, JObjectLocalRef localRef, Byte signature,
		JMethodId methodId, JValue* ptr, in CallGenericFunction<JObjectLocalRef, TPrimitive> callFunction)
		where TPrimitive : unmanaged, INativeDataType<TPrimitive>, IPrimitiveType<TPrimitive>
	{
