...
internal readonly unsafe struct NewPrimitiveArrayFunction<TArrayRef>
	where TArrayRef : unmanaged, IArrayReferenceType<TArrayRef>, IObjectReferenceType
{
	/// <summary>
	/// Pointer to <c>New&lt;PrimitiveType&gt;Array</c> function.
	/// Constructs a new primitive array object.
	/// </summary>
	private readonly delegate* unmanaged<IntPtr, Int32, IntPtr> _ptr;
	...
	public TArrayRef NewArray(JEnvironmentRef envRef, Int32 length) => TArrayRef.New(this._ptr(envRef.Pointer, length));
}