...
internal delegate JClassLocalRef DefineClassDelegate(JEnvironmentRef env, ReadOnlyValPtr<Byte> nameChars0,
...
internal delegate JMethodId GetMethodIdDelegate(JEnvironmentRef env, JClassLocalRef jClass,
	ReadOnlyValPtr<Byte> nameChars0, ReadOnlyValPtr<Byte> signatureChars0);

internal delegate JFieldId GetFieldIdDelegate(JEnvironmentRef env, JClassLocalRef jclass,
	ReadOnlyValPtr<Byte> nameChars0, ReadOnlyValPtr<Byte> signatureChars0);

internal delegate JMethodId GetStaticMethodIdDelegate(JEnvironmentRef env, JClassLocalRef jClass,
	ReadOnlyValPtr<Byte> nameChars0, ReadOnlyValPtr<Byte> signatureChars0);

internal delegate JFieldId GetStaticFieldIdDelegate(JEnvironmentRef env, JClassLocalRef jclass,
	ReadOnlyValPtr<Byte> nameChars0, ReadOnlyValPtr<Byte> signatureChars0);
