...
internal delegate JClassLocalRef DefineClassDelegate(JEnvironmentRef env, in Byte nameChars0, JObjectLocalRef loader,
	IntPtr binaryData, Int32 len);

internal delegate JClassLocalRef FindClassDelegate(JEnvironmentRef env, in Byte nameChars0);
...
internal delegate JMethodId GetMethodIdDelegate(JEnvironmentRef env, JClassLocalRef jClass, in Byte nameChars0,
	in Byte signatureChars0);

internal delegate JFieldId GetFieldIdDelegate(JEnvironmentRef env, JClassLocalRef jclass, in Byte nameChars0,
	in Byte signatureChars0);

internal delegate JMethodId GetStaticMethodIdDelegate(JEnvironmentRef env, JClassLocalRef jClass, in Byte nameChars0,
	in Byte signatureChars0);

internal delegate JFieldId GetStaticFieldIdDelegate(JEnvironmentRef env, JClassLocalRef jclass, in Byte nameChars0,
	in Byte signatureChars0);
