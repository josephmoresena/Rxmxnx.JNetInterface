...
internal delegate JResult ThrowNewDelegate(JEnvironmentRef env, JClassLocalRef jClass, in Byte messageChars0);
...
internal delegate void FatalErrorDelegate(JEnvironmentRef env, in Byte messageChars0);
