...
public partial class JVirtualMachine
{
	...
	private sealed partial record VirtualMachineCache : GlobalMainClasses
	{
		...
		public JGlobal? Register(JGlobal? jGlobal)
		{
			...
			if (UnicodeClassNames.ClassObject.AsSpan().SequenceEqual(jGlobal.ObjectMetadata.ObjectClassName))
		...
		public JWeak? Register(JWeak? jWeak)
		{
			...
			if (UnicodeClassNames.ClassObject.AsSpan().SequenceEqual(jWeak.ObjectMetadata.ObjectClassName))
