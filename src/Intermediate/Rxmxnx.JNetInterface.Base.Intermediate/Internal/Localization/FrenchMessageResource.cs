...
internal sealed class FrenchMessageResource : IMessageResource
{
	...
	String IMessageResource.InvalidArrayDimension
		=> "Les dimensions d’un tableau doivent être comprises entre 1 et 255.";
	...
	String IMessageResource.AbstractClass(String className) => $"{className} est un type abstrait.";
