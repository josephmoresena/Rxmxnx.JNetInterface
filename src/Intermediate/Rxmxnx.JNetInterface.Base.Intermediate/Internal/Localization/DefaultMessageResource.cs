...
internal sealed class DefaultMessageResource : IMessageResource
{
	...
	String IMessageResource.InvalidArrayDimension => "Array dimensions must be between 1 and 255.";
	...
	String IMessageResource.AbstractClass(String className) => $"{className} is an abstract type.";
