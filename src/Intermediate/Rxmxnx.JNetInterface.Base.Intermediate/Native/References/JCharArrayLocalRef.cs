...
public readonly partial struct JCharArrayLocalRef : IFixedPointer, INative<JCharArrayLocalRef>, IWrapper<JObjectLocalRef>,
	IEquatable<JCharArrayLocalRef>, IEquatable<JArrayLocalRef>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public Boolean Equals(JCharArrayLocalRef other) => this._value.Equals(other._value);
	/// <inheritdoc/>
	...
	/// <inheritdoc/>
	public override Boolean Equals(Object? obj) => obj is JCharArrayLocalRef other && this.Equals(other);
	/// <inheritdoc/>
