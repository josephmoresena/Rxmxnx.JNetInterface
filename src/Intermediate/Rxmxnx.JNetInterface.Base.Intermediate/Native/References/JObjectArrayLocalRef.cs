...
public readonly partial struct JObjectArrayLocalRef : IArrayReferenceType<JObjectArrayLocalRef>
{
	/// <inheritdoc/>
	...
	public JObjectArrayLocalRef(IntPtr value) => this._value = new(value);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	static JObjectArrayLocalRef IArrayReferenceType<JObjectArrayLocalRef>.New(IntPtr value) => new(value);
}