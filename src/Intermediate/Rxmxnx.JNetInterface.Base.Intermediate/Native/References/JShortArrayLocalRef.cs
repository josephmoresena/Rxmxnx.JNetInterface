...
public readonly partial struct JShortArrayLocalRef : IFixedPointer, INative<JShortArrayLocalRef>, IWrapper<JObjectLocalRef>,
    IEquatable<JShortArrayLocalRef>, IEquatable<JArrayLocalRef>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public Boolean Equals(JShortArrayLocalRef other) => this._value.Equals(other._value);
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public override Boolean Equals(Object? obj) => obj is JShortArrayLocalRef other && this.Equals(other);
    /// <inheritdoc/>
