...
public interface IAccessor
{
	...
	TResult? GetField<TResult>(JLocalObject jLocal, JFieldDefinition definition) 
	...
	TField? GetStaticField<TField>(IClass jClass, JFieldDefinition definition) 
		where TField : IDataType<TField>;
	/// <summary>
	...
	TResult? CallStaticFunction<TResult>(IClass jClass, JFunctionDefinition definition, IObject?[] args)
		where TResult : IDataType<TResult>;/// <summary>
	...
	/// <param name="args">The <see cref="IObject"/> array with call arguments.</param>
	/// <returns><typeparamref name="TResult"/> function result.</returns>
	TResult? CallNonVirtualFunction<TResult>(JLocalObject jLocal, IClass jClass, JFunctionDefinition definition, IObject?[] args) 
		where TResult : IDataType<TResult>;
	/// <summary>
