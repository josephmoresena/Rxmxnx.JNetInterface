...
internal sealed class DeadThread : IThread, IReferenceFeature, IStringFeature, IArrayFeature, IClassFeature
{
	...
	void IReferenceFeature.MonitorEnter(JObjectLocalRef localRef) => DeadThread.ThrowInvalidResult<ObjectLifetime>();
	...
	JStringObject IStringFeature.Create(ReadOnlySpan<Byte> utf8Data) => DeadThread.ThrowInvalidResult<JStringObject>();
