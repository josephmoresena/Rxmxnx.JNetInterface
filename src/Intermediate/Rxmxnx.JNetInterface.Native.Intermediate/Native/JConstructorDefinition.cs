...
public record JConstructorDefinition : JCallDefinition
{
	...
	public TObject New<TObject>(IEnvironment env) 
	...
	/// <param name="args">The arguments to pass to.</param>
	/// <returns>A new <typeparamref name="TObject"/> instance.</returns>
	protected TObject New<TObject>(IEnvironment env, IObject?[] args) 
		where TObject : JLocalObject, IDataType<TObject>
	...
	private TObject New<TObject>(JClassObject jClass, IObject?[] args)
		where TObject : JLocalObject, IDataType<TObject>
	{
